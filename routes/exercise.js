...
router.post('/', authenticate, [
    ...
    try {
        ...
        const { title, description, education_level, subject_name, images, external_link } = req.body;
        ...
        const created = await insert('exercise_posts', newExerciseData);
...
router.put('/:id', authenticate, [
    ...
    try {
        ...
        const updated = await update('exercise_posts', exerciseId, updatedData);
